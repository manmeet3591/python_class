...
srcs_write_sfc =\
['src/_write_sfc.pyf','src/kinds.f90','src/sfcio_module.f90','src/write_sfc.f90']

ext_sfc_write = Extension(name     = '_write_sfc',
                    sources       = srcs_write_sfc)
...
if __name__ == "__main__":
    setup(name = 'gfstonc',
          ...
          ext_modules       = [ext_spec,ext_sigma_nemsio,ext_sfcflx_nemsio,ext_sfc, ext_sfc_write],
